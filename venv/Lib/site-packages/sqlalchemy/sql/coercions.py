...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Iterable, Iterator,
                    List, NoReturn, Optional, Sequence, Tuple, Type, TypeVar,
                    Union, cast, overload)
...
if typing.TYPE_CHECKING:
    ...
    from .selectable import (FromClause, HasCTE, SelectBase, Subquery,
                             _ColumnsClauseElement, _JoinTargetProtocol)
