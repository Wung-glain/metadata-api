...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Generic, Iterable,
                    Mapping, NoReturn, Optional, Set, Tuple, Type, TypeVar,
                    Union, overload)
...
if TYPE_CHECKING:
    ...
    from .elements import (ClauseElement, ColumnElement, KeyedColumnElement,
                           SQLCoreOperations, TextClause, quoted_name)
    from .lambdas import LambdaElement
    from .roles import FromClauseRole
    from .schema import Column
    from .selectable import (CTE, Alias, CompoundSelect, FromClause, Join,
                             NamedFromClause, ReturnsRows, Select, Selectable,
                             SelectBase, Subquery, TableClause)
