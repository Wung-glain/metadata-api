...
from typing import (TYPE_CHECKING, Any, Callable, ClassVar, Dict, FrozenSet,
                    ...
                    NamedTuple, NoReturn, Optional, Pattern, Sequence, Set,
                    Tuple, Type, Union, cast)

from .. import exc, util
from ..util import FastIntFlag
from ..util.typing import Literal, Protocol, Self, TypedDict
from . import (base, coercions, crud, elements, functions, operators, roles,
               schema, selectable, sqltypes)
from . import util as sql_util
from ._typing import is_column_element, is_dml
from .base import (_NONE_NAME, NO_ARG, _de_clone, _from_objects,
...
if typing.TYPE_CHECKING:
    ...
    from ..engine.interfaces import (Dialect, SchemaTranslateMapType,
    ...
    from .elements import (BinaryExpression, BindParameter, ClauseElement,
                           ColumnClause, ColumnElement, False_, Label, Null,
                           True_, _truncated_label)
    from .functions import Function
    from .schema import (Column, Constraint, ForeignKeyConstraint, Index,
                         PrimaryKeyConstraint, Table, UniqueConstraint)
    from .selectable import (CTE, AliasedReturnsRows, CompoundSelectState,
                             FromClause, NamedFromClause, ReturnsRows, Select,
                             SelectState, _ColumnsClauseElement)
    from .type_api import (TypeDecorator, TypeEngine, UserDefinedType,
                           _BindProcessorType)
