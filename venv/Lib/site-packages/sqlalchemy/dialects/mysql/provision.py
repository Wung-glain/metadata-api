...
from ... import exc
from ...testing.provision import (configure_follower, create_db, drop_db,
                                  generate_driver_url, temp_table_keyword_args,
                                  upsert)
...
def generate_driver_url(url, driver, query_str):
    ...
    if driver == "mariadbconnector":
        ...
        new_url = new_url.update_query_pairs([("collation", "utf8mb4_general_ci")])
