...
from typing import (TYPE_CHECKING, Any, Generic, List, Optional, Sequence,
...
from .operators import (ADJACENT_TO, CONTAINED_BY, CONTAINS,
                        NOT_EXTEND_LEFT_OF, NOT_EXTEND_RIGHT_OF, OVERLAP,
                        STRICTLY_LEFT_OF, STRICTLY_RIGHT_OF)
