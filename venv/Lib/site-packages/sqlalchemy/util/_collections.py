...
import typing
import weakref
from typing import (Any, Callable, Container, Dict, FrozenSet, Generic,
                    Iterable, Iterator, List, Mapping, NoReturn, Optional,
...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from sqlalchemy.cyextension.collections import \
        unique_list as unique_list  # noqa
