...
from mypy.nodes import (CLASSDEF_NO_INFO, CallExpr, ClassDef, Context,
                        Expression, FuncDef, IfStmt, JsonDict, MemberExpr,
                        NameExpr, Statement, SymbolTableNode, TypeAlias,
                        TypeInfo)
...
from mypy.types import (CallableType, Instance, NoneType, Type, TypeVarType,
