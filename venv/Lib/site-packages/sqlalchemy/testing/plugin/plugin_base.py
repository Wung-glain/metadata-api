...
def setup_options(make_option):
    ...
    make_option(
        ...
        type=str,
        help="Include tests with tag <tag>; " "legacy, use pytest -m 'tag' instead",
    )
    make_option(
        "--exclude-tag",
        action="callback",
        ...
        type=str,
        help="Exclude tests with tag <tag>; " "legacy, use pytest -m 'not tag' instead",
    )
    make_option(
        "--write-profiles",
        action="store_true",
...
def read_config(root_path):
    ...
    file_config.read([str(root_path / "setup.cfg"), str(root_path / "test.cfg")])
...
def post_begin():
    ...
    from sqlalchemy.testing import (assertions, config, exclusions, fixtures,
                                    profiling, provision, warnings)
