...
from ..sql.elements import TextClause, quoted_name
...
if TYPE_CHECKING:
    from .interfaces import (Dialect, ReflectedCheckConstraint,
                             ReflectedColumn, ReflectedForeignKeyConstraint,
                             ReflectedIndex, ReflectedPrimaryKeyConstraint,
                             ReflectedTableComment, ReflectedUniqueConstraint,
                             TableKey)
