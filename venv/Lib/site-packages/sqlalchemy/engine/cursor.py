...
import operator
import typing
from typing import (TYPE_CHECKING, Any, ClassVar, Dict, Iterable, Iterator,
                    List, Mapping, NoReturn, Optional, Sequence, Tuple,
                    TypeVar, Union, cast)

from .. import exc, util
from ..sql import elements, sqltypes
...
from .result import (IteratorResult, MergedResult, Result, ResultMetaData,
                     SimpleResultMetaData, tuplegetter)
from .row import Row
...
if typing.TYPE_CHECKING:
    ...
    from .interfaces import (DBAPICursor, Dialect, ExecutionContext,
                             _DBAPICursorDescription)
    from .result import (_KeyIndexType, _KeyMapRecType, _KeyMapType, _KeyType,
                         _ProcessorsType, _TupleGetterType)
...
class CursorResultMetaData(ResultMetaData):
    ...
    def __init__(
        ...
        if context.result_column_struct:
            ...
            result_columns = cols_are_ordered = (  # type: ignore
                num_ctx_cols
            ) = ad_hoc_textual = loose_column_name_matching = textual_ordered = False
    ...
    ) -> Dict[Union[str, object], Tuple[str, Tuple[Any, ...], TypeEngine[Any], int]]:
