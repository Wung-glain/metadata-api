...
from typing import (TYPE_CHECKING, Any, Awaitable, Callable, ClassVar,
                    Collection, Dict, Iterable, Iterator, List, Mapping,
                    MutableMapping, Optional, Sequence, Set, Tuple, Type,
                    TypeVar, Union)
...
if TYPE_CHECKING:
    ...
    from ..sql.compiler import (DDLCompiler, IdentifierPreparer,
                                InsertmanyvaluesSentinelOpts, Linting,
                                SQLCompiler, _InsertManyValuesBatch)
