...
if TYPE_CHECKING:
    ...
    from .attributes import (AttributeImpl, CollectionAttributeImpl,
                             HasCollectionAdapter, QueryableAttribute)
    from .base import PassiveFlag
    from .decl_api import registry as _registry_type
    from .interfaces import (InspectionAttr, MapperProperty, ORMOption,
                             UserDefinedOption)
