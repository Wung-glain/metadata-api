...
from typing import (Any, Callable, Collection, Dict, FrozenSet, Generic,
                    Iterable, Iterator, List, NamedTuple, NoReturn, Optional,
...
from ..sql.util import (ClauseAdapter, _deep_annotate, _deep_deannotate,
                        _shallow_annotate, adapt_criterion_to_null,
                        join_condition, selectables_overlap,
                        visit_binary_product)
from ..util.typing import (Literal, de_optionalize_union_types,
...
from .base import (DynamicMapped, LoaderCallableStatus, PassiveFlag,
                   WriteOnlyMapped, _DeclarativeMapped, _is_mapped_class,
                   class_mapper, state_str)
from .interfaces import (MANYTOMANY, MANYTOONE, ONETOMANY, PropComparator,
                         RelationshipDirection, StrategizedProperty,
                         _AttributeOptions, _IntrospectsAnnotations)
from .util import CascadeOptions, _orm_annotate, _orm_deannotate

if typing.TYPE_CHECKING:
    from ..sql._typing import (_CoreAdapterProto, _EquivalentColumnMap,
                               _InfoType)
    ...
    from ._typing import (_O, _EntityType, _ExternalEntityType,
                          _IdentityKeyType, _InstanceDict, _InternalEntityType,
                          _RegistryType)
