...
from ..sql.sqltypes import Concatenable, Integer, Numeric
from ..util import warn_deprecated
from . import exc as orm_exc
from .base import LoaderCallableStatus, PassiveFlag
...
class _EvaluatorCompiler:
    ...
    def visit_column(self, clause):
        ...
        try:
            ...
            raise UnevaluatableError(f"Cannot evaluate expression: {err}") from err
