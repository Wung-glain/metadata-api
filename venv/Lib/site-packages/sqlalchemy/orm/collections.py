...
from typing import (TYPE_CHECKING, Any, Callable, Collection, Dict, Iterable,
                    List, NoReturn, Optional, Set, Tuple, Type, TypeVar, Union,
                    cast)
...
if typing.TYPE_CHECKING:
    ...
    from .mapped_collection import (attribute_keyed_dict, column_keyed_dict,
                                    keyfunc_mapping)
...
def __go(lcls):
    ...
    from .mapped_collection import (KeyFuncDict, MappedCollection,
                                    attribute_keyed_dict,
                                    attribute_mapped_collection,
                                    column_keyed_dict,
                                    column_mapped_collection, keyfunc_mapping,
                                    mapped_collection)
